...
class Camera:
    ...
    def __init__(self, usbdevnum=0, width=1280, height=720, host, tcp_port=5678, udp_port=1259, pan_controller, tilt_controller, zoom_controller):
