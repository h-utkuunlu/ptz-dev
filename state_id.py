...
from dnn import real_time_evaluate, read_stats, Normalize, Resize, ToTensor, real_time_evaluate_fastai
...
def async_id_fastai(parent):
    ...
    prediction = real_time_evaluate_fastai(parent.network, Image(data_prep(roi)))[0]
    if prediction == 1:
        return 1
    else:
        return 0
